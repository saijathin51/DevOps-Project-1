...
Add the [***repository***](https://github.com/saijathin51/DevOps-Project-1.git) and branch details in the fields, Add the jenkins file name in the script path. Click on the ***GitHub hook trigger for GitSCM*** pooling.
